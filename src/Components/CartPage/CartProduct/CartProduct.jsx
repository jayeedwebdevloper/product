            ...
            <div className="col-12 col-lg-6">
                <div className="details">
                    ...
                    <div className="counter">
                        <div className="btn-group pe-3 shadow-sm" role="group" aria-label="Basic example">
                        ...
                        <Link to='/complete'><button className='btn btn-dark rounded-0 btn-200px'>Order Now</button></Link>
                    </div>
                </div>
            </div>
        </div>
